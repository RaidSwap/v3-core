...
describe('RaidswapV3Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as RaidswapV3Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('RaidswapV3Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('RaidswapV3Pool')
